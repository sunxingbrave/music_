...
export default {
  ...
  props: {
      ...
      pic: String,
      loading: Boolean,
      noResultText: { // 通常可修改的文案放在props里,data里没机会取修改
          type: String,
          default: '抱歉，没有找到可播放的音乐'
      }
  },
  data() {
      return {
  ...
  mounted() {
      this.imageHeight = this.$refs.bgImage.clientHeight // 动态获取图片的高度
